...
# Pull COALINDIA.NS
df = pd.read_sql("SELECT ts as date, high, low, close FROM daily_bars WHERE symbol='COALINDIA.NS' ORDER BY date ASC", conn)
...
# Look at the start of the simulation Jan 4th - Jan 10th
print("COALINDIA Data at start of simulation (2026-01-04):")
print(df.loc["2025-12-25":"2026-01-10"])
